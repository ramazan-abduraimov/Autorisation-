...
class KnigiPage extends StatefulWidget {
  const KnigiPage({super.key});

  @override
  State<KnigiPage> createState() => _KnigiPageState();
}

class _KnigiPageState extends State<KnigiPage> {
  @override
            ...
            child: Column(children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    "In these shelfbook will be motivation books. I have ",
                  ),
                ],
              ),
              Row(
                children: [
                  ...
                  Text(
                    "to learn all these book during this months and I ",
                  ),
                ],
              ),
              Row(
                children: [
                  ...
                  Text(
                    "have to write that words wich motivate me more ....",
                  ),
                ],
              ),
            ]),
...
// Padding(
//                       padding: const EdgeInsets.fromLTRB(220, 25, 0, 0),
//                       child: TextButton(
//                           onPressed: () {},
//                           child: Text(
//                             ">",
